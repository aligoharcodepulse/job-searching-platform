...
export default function CandidateNavbar() {
  ...
  const menuItems = [
    { label: "Home", path: `/candidate-dashboard/${uid}`, icon: faHome },
    {
      label: "About",
      path: `/candidate-dashboard/${uid}/about`,
      icon: faInfoCircle,
    },
    {
      label: "Contact",
      path: `/candidate-dashboard/${uid}/contact`,
      icon: faEnvelope,
    },
    {
      label: "Support",
      path: `/candidate-dashboard/${uid}/support`,
      icon: faLifeRing,
    },
  ];
